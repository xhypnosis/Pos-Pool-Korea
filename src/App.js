    ...
    >
      <Router>
        <Layout className="layout">
          ...
          <div className="flex flex-col h-[900px] relative overflow-x-hidden bg-block bg-no-repeat bg-top" style={{ backgroudSize: "1920px 348px" }}>
            <Header />
            ...
            <Content style={{ marginTop: "150px", backgroundColor: 'transparent' }}>
              <div>
                <Routes>
                  ...
                  <Route path="pool/core/:poolAddress" element={<Pool />} />
                  <Route path="pool/e-space/:poolAddress" element={<Pool />} />
                  <Route path="/" element={<Navigate to="pool/core/0x8de1a4b31fbc71b761320bf677ca3e70c2298d0a"/>} />
                </Routes>
              </div>
            </Content>
